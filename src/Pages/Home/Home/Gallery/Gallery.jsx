...
const Gallery = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-gray-200 via-red-100 mb-10 rounded-xl py-2">
      <h2 className="text-2xl md:text-5xl lg:text-5xl font-sans font-bold text-red-500 animate-pulse bg-gradient-to-r bg-clip-text  from-red-200 to-fuchsia-500 opacity-90 text-center my-20 mb-20 divider">
